...
function init() {
  ...
  //--------------------------- Important Variables----------------------------
  botLogoPath = "./imgs/robBot.png";

  //--------------------------- Chatbot Frontend -------------------------------
  const chatContainer = document.getElementById("chat-container");

  template = ` <button class='chat-btn'><img src = "./icons/comment.png" class = "icon icon-comment" ></button>
    ...
    <div class='chat-popup'>
		...
		<div class='chat-header'>
			...
			<h3 class='bot-title'>Yachay Bot</h3>
		...
		<div class='chat-area'>
            <div class='bot-msg'>
				...
				<span class='msg'>Hola, ¿cómo te puedo ayudar?</span>
			</div>
		...
		<div class='chat-input-area'>
			...
			<button class='chat-submit'><i class='material-icons'>enviar</i></button>
		</div>
  ...
  //--------------------------- Important Variables----------------------------
  var inactiveMessage =
    "El servidor está inactivo. Por favor intente más tarde.";
  ...
  chatBtn.addEventListener("click", () => {
    ...
    if (chatPopup.style.display == "none" && mobileDevice) {
      ...
      chatInput.focus();
      chatBtn.innerHTML = `<img src = "./icons/comment.png" class = "icon icon-comment" >`;
...
function chatbotTheme(theme) {
  ...
  const blue = {
    color: "#0600c0",
    background: "linear-gradient(19deg, #21D4FD 0%, #009dc8 100%)",
  };
